...
project = u'oastools'
copyright = u'{}, Bilal Shaikh'.format(datetime.datetime.now().year)
author = u'Bilal Shaikh'
...
filename = os.path.join(os.path.dirname(__file__), '..', 'oastools', 'VERSION')
...
htmlhelp_basename = 'oastools-doc'
...
""" latex_documents = [
    (master_doc, 'oastools.tex', u'oastools documentation',
     u'Bilal Shaikh', 'manual'),
] """
...
""" man_pages = [
    (master_doc, 'oastools', u'oastools documentation',
     [author], 1)
]
 """
# If true, show URL addresses after external links.
...
""" texinfo_documents = [
    (master_doc, 'oastools', u'oastools documentation',
     author, 'oastools', 'One line description of project.',
     'Miscellaneous'),
] """
